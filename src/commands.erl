...
get_request_id(Command) when is_tuple(Command) ->
	case Command of
		...
		#'CommandPartitionedTopicMetadataResponse'{} -> Command#'CommandPartitionedTopicMetadataResponse'.request_id;
		_ -> false
	end.
...
set_request_id(Command, ReqId) when is_tuple(Command) ->
	case Command of
		...
		#'CommandPartitionedTopicMetadata'{} -> Command#'CommandPartitionedTopicMetadata'{request_id = ReqId};
		_ ->
			false
	end.
