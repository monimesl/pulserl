...
-type 'CommandPartitionedTopicMetadataResponse'() :: #'CommandPartitionedTopicMetadataResponse'{}.
...
-type 'CommandRedeliverUnacknowledgedMessages'() :: #'CommandRedeliverUnacknowledgedMessages'{}.
...
encode_msg_Schema(#'Schema'{name = F1, schema_data = F2,
	type = F3, properties = F4},
		Bin, TrUserData) ->
	B1 = begin
...
encode_msg_KeyValue(#'KeyValue'{key = F1, value = F2},
		Bin, TrUserData) ->
	B1 = begin
		     TrF1 = id(F1, TrUserData),
		     e_type_string(TrF1, <<Bin/binary, 10>>, TrUserData)
...
encode_msg_KeyLongValue(#'KeyLongValue'{key = F1,
	value = F2},
		Bin, TrUserData) ->
	B1 = begin
		     TrF1 = id(F1, TrUserData),
...
encode_msg_MessageMetadata(#'MessageMetadata'{producer_name
= F1,
	sequence_id = F2,
	publish_time = F3,
	properties = F4,
...
encode_msg_SingleMessageMetadata(#'SingleMessageMetadata'{properties
= F1,
	partition_key = F2,
	payload_size = F3,
	compacted_out = F4,
...
encode_msg_CommandConnect(#'CommandConnect'{client_version
= F1,
	auth_method = F2,
	auth_method_name = F3,
	auth_data = F4,
...
encode_msg_CommandConnected(#'CommandConnected'{server_version
= F1,
	protocol_version = F2,
	max_message_size = F3},
		Bin, TrUserData) ->
...
encode_msg_CommandAuthResponse(#'CommandAuthResponse'{client_version
= F1,
	response = F2,
	protocol_version = F3},
		Bin, TrUserData) ->
...
encode_msg_CommandAuthChallenge(#'CommandAuthChallenge'{server_version
= F1,
	challenge = F2,
	protocol_version = F3},
		Bin, TrUserData) ->
...
encode_msg_AuthData(#'AuthData'{auth_method_name = F1,
	auth_data = F2},
		Bin, TrUserData) ->
	B1 = if F1 == undefined -> Bin;
		     true ->
...
encode_msg_CommandSubscribe(#'CommandSubscribe'{topic =
F1,
...
encode_msg_CommandPartitionedTopicMetadata(#'CommandPartitionedTopicMetadata'{topic
=
F1,
	request_id
	=
...
encode_msg_CommandLookupTopic(#'CommandLookupTopic'{topic
= F1,
	request_id = F2,
	authoritative = F3,
...
encode_msg_CommandLookupTopicResponse(#'CommandLookupTopicResponse'{brokerServiceUrl
= F1,
	brokerServiceUrlTls
	= F2,
	response =
...
encode_msg_CommandProducer(#'CommandProducer'{topic =
F1,
	producer_id = F2, request_id = F3,
	producer_name = F4,
	encrypted = F5, metadata = F6,
	schema = F7},
		Bin, TrUserData) ->
	B1 = begin
		     TrF1 = id(F1, TrUserData),
...
encode_msg_CommandSend(#'CommandSend'{producer_id = F1,
	sequence_id = F2, num_messages = F3},
		Bin, TrUserData) ->
	B1 = begin
		     TrF1 = id(F1, TrUserData),
		     e_varint(TrF1, <<Bin/binary, 8>>, TrUserData)
...
encode_msg_CommandSendReceipt(#'CommandSendReceipt'{producer_id
= F1,
	sequence_id = F2,
	message_id = F3},
		Bin, TrUserData) ->
...
encode_msg_CommandSendError(#'CommandSendError'{producer_id
= F1,
	sequence_id = F2, error = F3,
	message = F4},
		Bin, TrUserData) ->
	B1 = begin
		     TrF1 = id(F1, TrUserData),
...
encode_msg_CommandMessage(#'CommandMessage'{consumer_id
= F1,
	message_id = F2,
	redelivery_count = F3},
		Bin, TrUserData) ->
...
encode_msg_CommandAck(#'CommandAck'{consumer_id = F1,
	ack_type = F2, message_id = F3,
	validation_error = F4, properties = F5},
		Bin, TrUserData) ->
	B1 = begin
		     TrF1 = id(F1, TrUserData),
		     e_varint(TrF1, <<Bin/binary, 8>>, TrUserData)
...
encode_msg_CommandActiveConsumerChange(#'CommandActiveConsumerChange'{consumer_id
= F1,
	is_active
	= F2},
		Bin, TrUserData) ->
...
encode_msg_CommandFlow(#'CommandFlow'{consumer_id = F1,
	messagePermits = F2},
		Bin, TrUserData) ->
	B1 = begin
		     TrF1 = id(F1, TrUserData),
...
encode_msg_CommandUnsubscribe(#'CommandUnsubscribe'{consumer_id
= F1,
	request_id = F2},
		Bin, TrUserData) ->
	B1 = begin
...
encode_msg_CommandReachedEndOfTopic(#'CommandReachedEndOfTopic'{consumer_id
= F1},
		Bin, TrUserData) ->
	begin
		TrF1 = id(F1, TrUserData),
...
encode_msg_CommandCloseProducer(#'CommandCloseProducer'{producer_id
= F1,
	request_id = F2},
		Bin, TrUserData) ->
	B1 = begin
...
encode_msg_CommandCloseConsumer(#'CommandCloseConsumer'{consumer_id
= F1,
	request_id = F2},
		Bin, TrUserData) ->
	B1 = begin
...
encode_msg_CommandSuccess(#'CommandSuccess'{request_id =
F1,
	schema = F2},
		Bin, TrUserData) ->
	B1 = begin
...
encode_msg_CommandProducerSuccess(#'CommandProducerSuccess'{request_id
= F1,
	producer_name = F2,
	last_sequence_id =
	F3,
...
encode_msg_CommandConsumerStats(#'CommandConsumerStats'{request_id
= F1,
	consumer_id = F2},
		Bin, TrUserData) ->
	B1 = begin
...
encode_msg_CommandConsumerStatsResponse(#'CommandConsumerStatsResponse'{request_id
=
F1,
	error_code
	=
...
encode_msg_CommandGetLastMessageId(#'CommandGetLastMessageId'{consumer_id
= F1,
	request_id = F2},
		Bin, TrUserData) ->
	B1 = begin
...
encode_msg_CommandGetTopicsOfNamespace(#'CommandGetTopicsOfNamespace'{request_id
= F1,
	namespace
	= F2,
	mode =
...
encode_msg_CommandGetSchema(#'CommandGetSchema'{request_id
= F1,
	topic = F2,
	schema_version = F3},
		Bin, TrUserData) ->
...
encode_msg_CommandGetSchemaResponse(#'CommandGetSchemaResponse'{request_id
= F1,
	error_code = F2,
	error_message =
	F3,
...
encode_msg_BaseCommand(#'BaseCommand'{type = F1,
	connect = F2, connected = F3,
	subscribe = F4, producer = F5, send = F6,
	send_receipt = F7, send_error = F8,
	message = F9, ack = F10, flow = F11,
	unsubscribe = F12, success = F13,
	error = F14, close_producer = F15,
	close_consumer = F16,
	producer_success = F17, ping = F18,
	pong = F19,
	...
	reachedEndOfTopic = F27, seek = F28,
	...
	getSchema = F34, getSchemaResponse = F35,
	authChallenge = F36, authResponse = F37},
		Bin, TrUserData) ->
	B1 = begin
		     TrF1 = id(F1, TrUserData),
...
dfp_read_field_def_Schema(<<>>, 0, 0, F@_1, F@_2, F@_3,
		R1, TrUserData) ->
	#'Schema'{name = F@_1, schema_data = F@_2, type = F@_3,
...
dfp_read_field_def_MessageIdData(<<>>, 0, 0, F@_1, F@_2,
		F@_3, F@_4, _) ->
	#'MessageIdData'{ledgerId = F@_1, entryId = F@_2,
		partition = F@_3, batch_index = F@_4};
...
dfp_read_field_def_EncryptionKeys(<<>>, 0, 0, F@_1,
		F@_2, R1, TrUserData) ->
	#'EncryptionKeys'{key = F@_1, value = F@_2,
...
dfp_read_field_def_MessageMetadata(<<152, 1,
	Rest/binary>>,
		...
		F@_14, F@_15, F@_16, F@_17, F@_18, F@_19,
		TrUserData) ->
	d_field_MessageMetadata_deliver_at_time(Rest, Z1, Z2,
		F@_1, F@_2, F@_3, F@_4, F@_5, F@_6,
		F@_7, F@_8, F@_9, F@_10, F@_11,
		F@_12, F@_13, F@_14, F@_15, F@_16,
		F@_17, F@_18, F@_19, TrUserData);
dfp_read_field_def_MessageMetadata(<<160, 1,
	Rest/binary>>,
		...
		F@_14, F@_15, F@_16, F@_17, F@_18, F@_19,
		TrUserData) ->
	d_field_MessageMetadata_marker_type(Rest, Z1, Z2, F@_1,
		F@_2, F@_3, F@_4, F@_5, F@_6, F@_7,
		F@_8, F@_9, F@_10, F@_11, F@_12, F@_13,
		F@_14, F@_15, F@_16, F@_17, F@_18,
		F@_19, TrUserData);
dfp_read_field_def_MessageMetadata(<<>>, 0, 0, F@_1,
	...
	#'MessageMetadata'{producer_name = F@_1,
		sequence_id = F@_2, publish_time = F@_3,
		properties = lists_reverse(R1, TrUserData),
		replicated_from = F@_5, partition_key = F@_6,
		replicate_to = lists_reverse(R2, TrUserData),
		compression = F@_8, uncompressed_size = F@_9,
		num_messages_in_batch = F@_10, event_time = F@_11,
		encryption_keys = lists_reverse(R3, TrUserData),
		encryption_algo = F@_13, encryption_param = F@_14,
		schema_version = F@_15,
		partition_key_b64_encoded = F@_16, ordering_key = F@_17,
		deliver_at_time = F@_18, marker_type = F@_19};
	...
	case Key of
		...
		146 ->
			d_field_MessageMetadata_ordering_key(Rest, 0, 0, F@_1,
				...
				TrUserData);
		152 ->
			d_field_MessageMetadata_deliver_at_time(Rest, 0, 0,
				F@_1, F@_2, F@_3, F@_4, F@_5,
				F@_6, F@_7, F@_8, F@_9, F@_10,
				F@_11, F@_12, F@_13, F@_14,
				F@_15, F@_16, F@_17, F@_18,
				F@_19, TrUserData);
		160 ->
			d_field_MessageMetadata_marker_type(Rest, 0, 0, F@_1,
				F@_2, F@_3, F@_4, F@_5, F@_6,
				F@_7, F@_8, F@_9, F@_10, F@_11,
				F@_12, F@_13, F@_14, F@_15, F@_16,
				F@_17, F@_18, F@_19, TrUserData);
...
d_field_MessageMetadata_sequence_id(<<1:1, X:7,
	...
	d_field_MessageMetadata_sequence_id(Rest, N + 7,
		...
		F@_5, F@_6, F@_7, F@_8, F@_9, F@_10,
		F@_11, F@_12, F@_13, F@_14, F@_15,
		F@_16, F@_17, F@_18, F@_19, TrUserData);
...
d_field_MessageMetadata_encryption_param(<<0:1, X:7,
	...
	dfp_read_field_def_MessageMetadata(RestF, 0, 0, F@_1,
		F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, F@_8,
		F@_9, F@_10, F@_11, F@_12, F@_13,
		NewFValue, F@_15, F@_16, F@_17, F@_18,
		F@_19, TrUserData).
...
d_field_MessageMetadata_schema_version(<<0:1, X:7,
	...
	dfp_read_field_def_MessageMetadata(RestF, 0, 0, F@_1,
		F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, F@_8,
		F@_9, F@_10, F@_11, F@_12, F@_13, F@_14,
		NewFValue, F@_16, F@_17, F@_18, F@_19,
		TrUserData).
...
d_field_MessageMetadata_partition_key_b64_encoded(<<0:1,
	...
	dfp_read_field_def_MessageMetadata(RestF, 0, 0, F@_1,
		F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, F@_8,
		F@_9, F@_10, F@_11, F@_12, F@_13, F@_14,
		F@_15, NewFValue, F@_17, F@_18, F@_19,
		TrUserData).
...
d_field_MessageMetadata_ordering_key(<<0:1, X:7,
	...
	dfp_read_field_def_MessageMetadata(RestF, 0, 0, F@_1,
		F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, F@_8,
		F@_9, F@_10, F@_11, F@_12, F@_13, F@_14,
		F@_15, F@_16, NewFValue, F@_18, F@_19,
		TrUserData).
...
d_field_MessageMetadata_deliver_at_time(<<1:1, X:7,
	Rest/binary>>,
		...
		F@_17, F@_18, F@_19, TrUserData)
	when N < 57 ->
	d_field_MessageMetadata_deliver_at_time(Rest, N + 7,
		X bsl N + Acc, F@_1, F@_2, F@_3,
		F@_4, F@_5, F@_6, F@_7, F@_8, F@_9,
		F@_10, F@_11, F@_12, F@_13, F@_14,
		F@_15, F@_16, F@_17, F@_18, F@_19,
...
d_field_MessageMetadata_deliver_at_time(<<0:1, X:7,
	...
	dfp_read_field_def_MessageMetadata(RestF, 0, 0, F@_1,
		F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, F@_8,
		F@_9, F@_10, F@_11, F@_12, F@_13, F@_14,
		F@_15, F@_16, F@_17, NewFValue, F@_19,
		TrUserData).
...
d_field_MessageMetadata_marker_type(<<1:1, X:7,
	Rest/binary>>,
		...
		F@_19, TrUserData)
	when N < 57 ->
	d_field_MessageMetadata_marker_type(Rest, N + 7,
		X bsl N + Acc, F@_1, F@_2, F@_3, F@_4,
		F@_5, F@_6, F@_7, F@_8, F@_9, F@_10,
		F@_11, F@_12, F@_13, F@_14, F@_15,
		F@_16, F@_17, F@_18, F@_19, TrUserData);
d_field_MessageMetadata_marker_type(<<0:1, X:7,
	...
	dfp_read_field_def_MessageMetadata(RestF, 0, 0, F@_1,
		F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, F@_8,
		F@_9, F@_10, F@_11, F@_12, F@_13, F@_14,
		F@_15, F@_16, F@_17, F@_18, NewFValue,
		TrUserData).
...
skip_varint_MessageMetadata(<<1:1, _:7, Rest/binary>>,
		...
		F@_15, F@_16, F@_17, F@_18, F@_19, TrUserData) ->
...
dfp_read_field_def_SingleMessageMetadata(<<64,
	Rest/binary>>,
		Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
		F@_6, F@_7, F@_8, TrUserData) ->
	d_field_SingleMessageMetadata_sequence_id(Rest, Z1, Z2,
		F@_1, F@_2, F@_3, F@_4, F@_5,
		F@_6, F@_7, F@_8, TrUserData);
dfp_read_field_def_SingleMessageMetadata(<<>>, 0, 0, R1,
	...
	lists_reverse(R1, TrUserData),
		partition_key = F@_2, payload_size = F@_3,
		compacted_out = F@_4, event_time = F@_5,
		partition_key_b64_encoded = F@_6,
		ordering_key = F@_7, sequence_id = F@_8};
	...
	case Key of
		...
		58 ->
			d_field_SingleMessageMetadata_ordering_key(Rest, 0, 0,
				...
				TrUserData);
		64 ->
			d_field_SingleMessageMetadata_sequence_id(Rest, 0, 0,
				F@_1, F@_2, F@_3, F@_4,
				F@_5, F@_6, F@_7, F@_8,
				TrUserData);
		_ ->
...
d_field_SingleMessageMetadata_sequence_id(<<1:1, X:7,
	Rest/binary>>,
		...
		F@_6, F@_7, F@_8, TrUserData)
	when N < 57 ->
	d_field_SingleMessageMetadata_sequence_id(Rest, N + 7,
		X bsl N + Acc, F@_1, F@_2, F@_3,
		F@_4, F@_5, F@_6, F@_7, F@_8,
		TrUserData);
...
dfp_read_field_def_CommandConnect(<<>>, 0, 0, F@_1,
	...
	#'CommandConnect'{client_version = F@_1,
		auth_method = F@_2, auth_method_name = F@_3,
		auth_data = F@_4, protocol_version = F@_5,
		proxy_to_broker_url = F@_6, original_principal = F@_7,
		original_auth_data = F@_8, original_auth_method = F@_9};
...
dfp_read_field_def_CommandConnected(<<24, Rest/binary>>,
		Z1, Z2, F@_1, F@_2, F@_3, TrUserData) ->
	d_field_CommandConnected_max_message_size(Rest, Z1, Z2,
		F@_1, F@_2, F@_3, TrUserData);
dfp_read_field_def_CommandConnected(<<>>, 0, 0, F@_1,
		F@_2, F@_3, _) ->
	#'CommandConnected'{server_version = F@_1,
		protocol_version = F@_2, max_message_size = F@_3};
	...
	case Key of
		...
		16 ->
			d_field_CommandConnected_protocol_version(Rest, 0, 0,
				...
				TrUserData);
		24 ->
			d_field_CommandConnected_max_message_size(Rest, 0, 0,
				F@_1, F@_2, F@_3,
				TrUserData);
		_ ->
			case Key band 7 of
				0 ->
					skip_varint_CommandConnected(Rest, 0, 0, F@_1, F@_2,
						F@_3, TrUserData);
				1 ->
					skip_64_CommandConnected(Rest, 0, 0, F@_1, F@_2, F@_3,
						TrUserData);
				2 ->
				...
				3 ->
					skip_group_CommandConnected(Rest, Key bsr 3, 0, F@_1,
						F@_2, F@_3, TrUserData);
				5 ->
					skip_32_CommandConnected(Rest, 0, 0, F@_1, F@_2, F@_3,
						TrUserData)
			end
	end;
...
d_field_CommandConnected_max_message_size(<<1:1, X:7,
	Rest/binary>>,
		N, Acc, F@_1, F@_2, F@_3, TrUserData)
	when N < 57 ->
	d_field_CommandConnected_max_message_size(Rest, N + 7,
		X bsl N + Acc, F@_1, F@_2, F@_3,
		TrUserData);
...
dfp_read_field_def_CommandAuthResponse(<<>>, 0, 0, F@_1,
	...
	#'CommandAuthResponse'{client_version = F@_1,
		response = F@_2, protocol_version = F@_3};
...
dfp_read_field_def_CommandAuthChallenge(<<>>, 0, 0,
	...
	#'CommandAuthChallenge'{server_version = F@_1,
		challenge = F@_2, protocol_version = F@_3};
...
dfp_read_field_def_CommandSubscribe(<<>>, 0, 0, F@_1,
		F@_2, F@_3, F@_4, F@_5, F@_6, F@_7, F@_8,
		F@_9, R1, F@_11, F@_12, F@_13, F@_14,
		TrUserData) ->
	#'CommandSubscribe'{topic = F@_1, subscription = F@_2,
		subType = F@_3, consumer_id = F@_4, request_id = F@_5,
		consumer_name = F@_6, priority_level = F@_7,
		durable = F@_8, start_message_id = F@_9,
		metadata = lists_reverse(R1, TrUserData),
		read_compacted = F@_11, schema = F@_12,
...
dfp_read_field_def_CommandLookupTopic(<<>>, 0, 0, F@_1,
	...
	#'CommandLookupTopic'{topic = F@_1, request_id = F@_2,
		authoritative = F@_3, original_principal = F@_4,
...
dfp_read_field_def_CommandLookupTopicResponse(<<>>, 0,
	...
	#'CommandLookupTopicResponse'{brokerServiceUrl = F@_1,
		brokerServiceUrlTls = F@_2, response = F@_3,
		request_id = F@_4, authoritative = F@_5,
		error = F@_6, message = F@_7,
...
dfp_read_field_def_CommandProducer(<<>>, 0, 0, F@_1,
		...
		TrUserData) ->
	#'CommandProducer'{topic = F@_1, producer_id = F@_2,
		request_id = F@_3, producer_name = F@_4,
		encrypted = F@_5,
		metadata = lists_reverse(R1, TrUserData),
		schema = F@_7};
...
dfp_read_field_def_CommandSend(<<>>, 0, 0, F@_1, F@_2,
		F@_3, _) ->
	#'CommandSend'{producer_id = F@_1, sequence_id = F@_2,
		num_messages = F@_3};
...
dfp_read_field_def_CommandSendReceipt(<<>>, 0, 0, F@_1,
	...
	#'CommandSendReceipt'{producer_id = F@_1,
		sequence_id = F@_2, message_id = F@_3};
...
dfp_read_field_def_CommandSendError(<<>>, 0, 0, F@_1,
	...
	#'CommandSendError'{producer_id = F@_1,
		sequence_id = F@_2, error = F@_3, message = F@_4};
...
dfp_read_field_def_CommandMessage(<<>>, 0, 0, F@_1,
		F@_2, F@_3, _) ->
	#'CommandMessage'{consumer_id = F@_1, message_id = F@_2,
...
dfp_read_field_def_CommandAck(<<>>, 0, 0, F@_1, F@_2,
	...
	#'CommandAck'{consumer_id = F@_1, ack_type = F@_2,
...
dfp_read_field_def_CommandActiveConsumerChange(<<>>, 0,
		0, F@_1, F@_2, _) ->
	#'CommandActiveConsumerChange'{consumer_id = F@_1,
		is_active = F@_2};
...
dfp_read_field_def_CommandUnsubscribe(<<>>, 0, 0, F@_1,
		F@_2, _) ->
	#'CommandUnsubscribe'{consumer_id = F@_1,
		request_id = F@_2};
...
dfp_read_field_def_CommandSeek(<<>>, 0, 0, F@_1, F@_2,
		F@_3, F@_4, _) ->
	#'CommandSeek'{consumer_id = F@_1, request_id = F@_2,
		message_id = F@_3, message_publish_time = F@_4};
...
dfp_read_field_def_CommandCloseProducer(<<>>, 0, 0,
		F@_1, F@_2, _) ->
	#'CommandCloseProducer'{producer_id = F@_1,
		request_id = F@_2};
...
dfp_read_field_def_CommandCloseConsumer(<<>>, 0, 0,
		F@_1, F@_2, _) ->
	#'CommandCloseConsumer'{consumer_id = F@_1,
		request_id = F@_2};
...
dfp_read_field_def_CommandProducerSuccess(<<>>, 0, 0,
	...
	#'CommandProducerSuccess'{request_id = F@_1,
		producer_name = F@_2, last_sequence_id = F@_3,
		schema_version = F@_4};
...
dfp_read_field_def_CommandError(<<>>, 0, 0, F@_1, F@_2,
		F@_3, _) ->
	#'CommandError'{request_id = F@_1, error = F@_2,
		message = F@_3};
...
dfp_read_field_def_CommandConsumerStats(<<>>, 0, 0,
		F@_1, F@_2, _) ->
	#'CommandConsumerStats'{request_id = F@_1,
		consumer_id = F@_2};
...
dfp_read_field_def_CommandConsumerStatsResponse(<<>>, 0,
	...
	#'CommandConsumerStatsResponse'{request_id = F@_1,
		error_code = F@_2, error_message = F@_3,
		msgRateOut = F@_4, msgThroughputOut = F@_5,
		msgRateRedeliver = F@_6,
		consumerName = F@_7,
		availablePermits = F@_8,
		unackedMessages = F@_9,
		blockedConsumerOnUnackedMsgs = F@_10,
		address = F@_11, connectedSince = F@_12,
		type = F@_13, msgRateExpired = F@_14,
		msgBacklog = F@_15};
...
dfp_read_field_def_CommandGetLastMessageId(<<>>, 0, 0,
		F@_1, F@_2, _) ->
	#'CommandGetLastMessageId'{consumer_id = F@_1,
		request_id = F@_2};
...
dfp_read_field_def_CommandGetSchema(<<>>, 0, 0, F@_1,
		F@_2, F@_3, _) ->
	#'CommandGetSchema'{request_id = F@_1, topic = F@_2,
		schema_version = F@_3};
...
dfp_read_field_def_CommandGetSchemaResponse(<<>>, 0, 0,
	...
	#'CommandGetSchemaResponse'{request_id = F@_1,
		error_code = F@_2, error_message = F@_3,
		schema = F@_4, schema_version = F@_5};
...
dfp_read_field_def_BaseCommand(<<>>, 0, 0, F@_1, F@_2,
	...
	#'BaseCommand'{type = F@_1, connect = F@_2,
		connected = F@_3, subscribe = F@_4, producer = F@_5,
		send = F@_6, send_receipt = F@_7, send_error = F@_8,
		message = F@_9, ack = F@_10, flow = F@_11,
		unsubscribe = F@_12, success = F@_13, error = F@_14,
		close_producer = F@_15, close_consumer = F@_16,
		producer_success = F@_17, ping = F@_18, pong = F@_19,
		redeliverUnacknowledgedMessages = F@_20,
		partitionMetadata = F@_21,
		partitionMetadataResponse = F@_22, lookupTopic = F@_23,
		lookupTopicResponse = F@_24, consumerStats = F@_25,
		consumerStatsResponse = F@_26,
		reachedEndOfTopic = F@_27, seek = F@_28,
		getLastMessageId = F@_29,
		getLastMessageIdResponse = F@_30,
		active_consumer_change = F@_31,
		getTopicsOfNamespace = F@_32,
		getTopicsOfNamespaceResponse = F@_33, getSchema = F@_34,
		getSchemaResponse = F@_35, authChallenge = F@_36,
		authResponse = F@_37};
...
merge_msg_Schema(#'Schema'{properties = PFproperties},
		#'Schema'{name = NFname, schema_data = NFschema_data,
			type = NFtype, properties = NFproperties},
		TrUserData) ->
	#'Schema'{name = NFname, schema_data = NFschema_data,
		type = NFtype,
		properties =
...
merge_msg_MessageIdData(#'MessageIdData'{partition =
PFpartition,
...
merge_msg_KeyValue(#'KeyValue'{},
		#'KeyValue'{key = NFkey, value = NFvalue}, _) ->
...
merge_msg_KeyLongValue(#'KeyLongValue'{},
		#'KeyLongValue'{key = NFkey, value = NFvalue}, _) ->
	#'KeyLongValue'{key = NFkey, value = NFvalue}.

-compile({nowarn_unused_function, merge_msg_EncryptionKeys/3}).
merge_msg_EncryptionKeys(#'EncryptionKeys'{metadata =
PFmetadata},
		#'EncryptionKeys'{key = NFkey, value = NFvalue,
			metadata = NFmetadata},
		TrUserData) ->
	#'EncryptionKeys'{key = NFkey, value = NFvalue,
		metadata =
		if PFmetadata /= undefined, NFmetadata /= undefined ->
			'erlang_++'(PFmetadata, NFmetadata,
				TrUserData);
...
merge_msg_MessageMetadata(#'MessageMetadata'{properties
= PFproperties,
	replicated_from =
	PFreplicated_from,
	...
	#'MessageMetadata'{producer_name = NFproducer_name,
		...
		if PFproperties /= undefined,
		NFproperties /= undefined ->
			'erlang_++'(PFproperties, NFproperties,
				TrUserData);
			PFproperties == undefined -> NFproperties;
			NFproperties == undefined -> PFproperties
		end,
		...
		if NFreplicated_from =:= undefined ->
			PFreplicated_from;
			true -> NFreplicated_from
		end,
		partition_key =
		if NFpartition_key =:= undefined -> PFpartition_key;
			true -> NFpartition_key
		end,
		replicate_to =
		if PFreplicate_to /= undefined,
		NFreplicate_to /= undefined ->
			'erlang_++'(PFreplicate_to, NFreplicate_to,
				TrUserData);
			PFreplicate_to == undefined -> NFreplicate_to;
			NFreplicate_to == undefined -> PFreplicate_to
		end,
		compression =
		if NFcompression =:= undefined -> PFcompression;
			true -> NFcompression
		end,
		uncompressed_size =
		...
		if NFnum_messages_in_batch =:= undefined ->
			PFnum_messages_in_batch;
			true -> NFnum_messages_in_batch
		end,
		event_time =
		if NFevent_time =:= undefined -> PFevent_time;
			true -> NFevent_time
		end,
		encryption_keys =
		if PFencryption_keys /= undefined,
		NFencryption_keys /= undefined ->
			'erlang_++'(PFencryption_keys,
				NFencryption_keys, TrUserData);
		...
		if NFencryption_algo =:= undefined ->
			PFencryption_algo;
			true -> NFencryption_algo
		end,
		encryption_param =
		if NFencryption_param =:= undefined ->
			PFencryption_param;
			true -> NFencryption_param
		end,
		schema_version =
		if NFschema_version =:= undefined ->
			PFschema_version;
			true -> NFschema_version
		end,
		partition_key_b64_encoded =
		if NFpartition_key_b64_encoded =:= undefined ->
			PFpartition_key_b64_encoded;
			true -> NFpartition_key_b64_encoded
		end,
		ordering_key =
		if NFordering_key =:= undefined -> PFordering_key;
			true -> NFordering_key
		end,
		deliver_at_time =
		if NFdeliver_at_time =:= undefined ->
			PFdeliver_at_time;
			true -> NFdeliver_at_time
		end,
		marker_type =
		if NFmarker_type =:= undefined -> PFmarker_type;
			true -> NFmarker_type
		end}.

-compile({nowarn_unused_function, merge_msg_SingleMessageMetadata/3}).
merge_msg_SingleMessageMetadata(#'SingleMessageMetadata'{properties
= PFproperties,
	partition_key =
	PFpartition_key,
	compacted_out =
...
merge_msg_CommandConnect(#'CommandConnect'{auth_method =
PFauth_method,
	auth_method_name =
	PFauth_method_name,
	...
	#'CommandConnect'{client_version = NFclient_version,
		auth_method =
		if NFauth_method =:= undefined -> PFauth_method;
			true -> NFauth_method
		end,
		auth_method_name =
		if NFauth_method_name =:= undefined ->
			PFauth_method_name;
			true -> NFauth_method_name
		end,
		auth_data =
		if NFauth_data =:= undefined -> PFauth_data;
			true -> NFauth_data
		end,
		protocol_version =
		...
		if NFproxy_to_broker_url =:= undefined ->
			PFproxy_to_broker_url;
			true -> NFproxy_to_broker_url
		end,
		original_principal =
		if NForiginal_principal =:= undefined ->
			PForiginal_principal;
			true -> NForiginal_principal
		end,
		original_auth_data =
		if NForiginal_auth_data =:= undefined ->
			PForiginal_auth_data;
			true -> NForiginal_auth_data
		end,
		original_auth_method =
		if NForiginal_auth_method =:= undefined ->
			PForiginal_auth_method;
			true -> NForiginal_auth_method
		end}.

-compile({nowarn_unused_function, merge_msg_CommandConnected/3}).
merge_msg_CommandConnected(#'CommandConnected'{protocol_version
= PFprotocol_version,
	max_message_size =
	PFmax_message_size},
		#'CommandConnected'{server_version =
		NFserver_version,
			protocol_version =
			NFprotocol_version,
			max_message_size =
	...
	#'CommandConnected'{server_version = NFserver_version,
		...
		if NFmax_message_size =:= undefined ->
			PFmax_message_size;
			true -> NFmax_message_size
		end}.

-compile({nowarn_unused_function, merge_msg_CommandAuthResponse/3}).
merge_msg_CommandAuthResponse(#'CommandAuthResponse'{client_version
= PFclient_version,
	response = PFresponse,
	protocol_version =
	PFprotocol_version},
	...
	if NFclient_version =:= undefined ->
		PFclient_version;
		true -> NFclient_version
	end,
		response =
		if PFresponse /= undefined,
		NFresponse /= undefined ->
			merge_msg_AuthData(PFresponse, NFresponse,
				TrUserData);
			PFresponse == undefined -> NFresponse;
			NFresponse == undefined -> PFresponse
		end,
		protocol_version =
		if NFprotocol_version =:= undefined ->
			PFprotocol_version;
...
merge_msg_CommandAuthChallenge(#'CommandAuthChallenge'{server_version
= PFserver_version,
	...
	if NFserver_version =:= undefined ->
		...
		challenge =
		if PFchallenge /= undefined,
		NFchallenge /= undefined ->
			merge_msg_AuthData(PFchallenge,
				NFchallenge,
				TrUserData);
			PFchallenge == undefined -> NFchallenge;
			NFchallenge == undefined -> PFchallenge
		end,
		protocol_version =
		if NFprotocol_version =:= undefined ->
			PFprotocol_version;
...
merge_msg_AuthData(#'AuthData'{auth_method_name =
PFauth_method_name,
	auth_data = PFauth_data},
		#'AuthData'{auth_method_name = NFauth_method_name,
			auth_data = NFauth_data},
		_) ->
...
merge_msg_CommandSubscribe(#'CommandSubscribe'{consumer_name
= PFconsumer_name,
	priority_level =
	PFpriority_level,
	durable = PFdurable,
	...
	PFreplicate_subscription_state},
		...
		TrUserData) ->
	#'CommandSubscribe'{topic = NFtopic,
		subscription = NFsubscription, subType = NFsubType,
		consumer_id = NFconsumer_id, request_id = NFrequest_id,
		consumer_name =
		if NFconsumer_name =:= undefined -> PFconsumer_name;
			true -> NFconsumer_name
		end,
		priority_level =
		if NFpriority_level =:= undefined ->
			PFpriority_level;
			true -> NFpriority_level
		end,
		durable =
		if NFdurable =:= undefined -> PFdurable;
			true -> NFdurable
		end,
		start_message_id =
		if PFstart_message_id /= undefined,
		...
		if NFread_compacted =:= undefined ->
			PFread_compacted;
			true -> NFread_compacted
		end,
		schema =
		if PFschema /= undefined, NFschema /= undefined ->
			merge_msg_Schema(PFschema, NFschema,
				TrUserData);
		...
		if NFinitialPosition =:= undefined ->
			PFinitialPosition;
			true -> NFinitialPosition
		end,
		replicate_subscription_state =
		if NFreplicate_subscription_state =:= undefined ->
			PFreplicate_subscription_state;
			true -> NFreplicate_subscription_state
		end}.
...
PForiginal_principal,
	...
	=
	PForiginal_auth_method},
		#'CommandPartitionedTopicMetadata'{topic
		=
		NFtopic,
			request_id
			=
	...
	#'CommandPartitionedTopicMetadata'{topic = NFtopic,
		request_id = NFrequest_id,
		original_principal =
		if NForiginal_principal =:=
			undefined ->
			PForiginal_principal;
			true -> NForiginal_principal
		end,
		original_auth_data =
		if NForiginal_auth_data =:=
			undefined ->
			PForiginal_auth_data;
			true -> NForiginal_auth_data
		end,
		original_auth_method =
		if NForiginal_auth_method =:=
			undefined ->
			PForiginal_auth_method;
			true -> NForiginal_auth_method
		end}.
...
merge_msg_CommandLookupTopic(#'CommandLookupTopic'{authoritative
= PFauthoritative,
	original_principal =
	PForiginal_principal,
	original_auth_data =
...
PFbrokerServiceUrl,
	...
	if NFbrokerServiceUrl =:= undefined ->
		PFbrokerServiceUrl;
		true -> NFbrokerServiceUrl
	end,
		brokerServiceUrlTls =
		if NFbrokerServiceUrlTls =:= undefined ->
			PFbrokerServiceUrlTls;
			true -> NFbrokerServiceUrlTls
		end,
		response =
		...
		proxy_through_service_url =
		if NFproxy_through_service_url =:=
			undefined ->
			PFproxy_through_service_url;
			true -> NFproxy_through_service_url
		end}.

-compile({nowarn_unused_function, merge_msg_CommandProducer/3}).
merge_msg_CommandProducer(#'CommandProducer'{producer_name
= PFproducer_name,
	...
	schema = PFschema},
		...
		TrUserData) ->
	#'CommandProducer'{topic = NFtopic,
		producer_id = NFproducer_id, request_id = NFrequest_id,
		producer_name =
		if NFproducer_name =:= undefined -> PFproducer_name;
			true -> NFproducer_name
		end,
		encrypted =
		if NFencrypted =:= undefined -> PFencrypted;
			true -> NFencrypted
		end,
		metadata =
		if PFmetadata /= undefined,
...
merge_msg_CommandSend(#'CommandSend'{num_messages =
PFnum_messages},
	...
	#'CommandSend'{producer_id = NFproducer_id,
		sequence_id = NFsequence_id,
		num_messages =
		if NFnum_messages =:= undefined -> PFnum_messages;
			true -> NFnum_messages
		end}.

-compile({nowarn_unused_function, merge_msg_CommandSendReceipt/3}).
merge_msg_CommandSendReceipt(#'CommandSendReceipt'{message_id
= PFmessage_id},
	...
	#'CommandSendReceipt'{producer_id = NFproducer_id,
		sequence_id = NFsequence_id,
		message_id =
		if PFmessage_id /= undefined,
		NFmessage_id /= undefined ->
			merge_msg_MessageIdData(PFmessage_id,
				NFmessage_id,
				TrUserData);
			PFmessage_id == undefined -> NFmessage_id;
			NFmessage_id == undefined -> PFmessage_id
		end}.
...
merge_msg_CommandMessage(#'CommandMessage'{message_id =
PFmessage_id,
	redelivery_count =
	PFredelivery_count},
	...
	#'CommandMessage'{consumer_id = NFconsumer_id,
		...
		if NFredelivery_count =:= undefined ->
			PFredelivery_count;
			true -> NFredelivery_count
		end}.

-compile({nowarn_unused_function, merge_msg_CommandAck/3}).
merge_msg_CommandAck(#'CommandAck'{message_id =
PFmessage_id,
	...
	#'CommandAck'{consumer_id = NFconsumer_id,
		...
		if PFmessage_id /= undefined,
		NFmessage_id /= undefined ->
			'erlang_++'(PFmessage_id, NFmessage_id,
				TrUserData);
			PFmessage_id == undefined -> NFmessage_id;
			NFmessage_id == undefined -> PFmessage_id
		end,
...
=
PFis_active},
		#'CommandActiveConsumerChange'{consumer_id
		=
		NFconsumer_id,
			is_active =
			NFis_active},
...
merge_msg_CommandSeek(#'CommandSeek'{message_id =
PFmessage_id,
...
merge_msg_CommandReachedEndOfTopic(#'CommandReachedEndOfTopic'{},
		#'CommandReachedEndOfTopic'{consumer_id =
		NFconsumer_id},
		_) ->
	#'CommandReachedEndOfTopic'{consumer_id =
	NFconsumer_id}.
...
merge_msg_CommandCloseProducer(#'CommandCloseProducer'{},
		#'CommandCloseProducer'{producer_id =
		NFproducer_id,
			request_id =
			NFrequest_id},
		_) ->
...
merge_msg_CommandCloseConsumer(#'CommandCloseConsumer'{},
		#'CommandCloseConsumer'{consumer_id =
		NFconsumer_id,
			request_id =
			NFrequest_id},
		_) ->
...
merge_msg_CommandSuccess(#'CommandSuccess'{schema =
PFschema},
...
PFlast_sequence_id,
	schema_version =
	PFschema_version},
		#'CommandProducerSuccess'{request_id =
		NFrequest_id,
			producer_name =
			NFproducer_name,
			last_sequence_id =
...
merge_msg_CommandError(#'CommandError'{},
		#'CommandError'{request_id = NFrequest_id,
			error = NFerror, message = NFmessage},
		_) ->
	#'CommandError'{request_id = NFrequest_id,
		error = NFerror, message = NFmessage}.
...
merge_msg_CommandConsumerStats(#'CommandConsumerStats'{},
		#'CommandConsumerStats'{request_id =
		NFrequest_id,
			consumer_id =
			NFconsumer_id},
		_) ->
...
PFerror_code,
	...
	=
	PFmsgBacklog},
		#'CommandConsumerStatsResponse'{request_id
		=
		NFrequest_id,
			error_code
			=
	...
	NFrequest_id,
		...
		if NFmsgThroughputOut =:= undefined ->
			PFmsgThroughputOut;
			true -> NFmsgThroughputOut
		end,
		msgRateRedeliver =
		if NFmsgRateRedeliver =:= undefined ->
			PFmsgRateRedeliver;
			true -> NFmsgRateRedeliver
		end,
		consumerName =
		...
		if NFavailablePermits =:= undefined ->
			PFavailablePermits;
			true -> NFavailablePermits
		end,
		unackedMessages =
		if NFunackedMessages =:= undefined ->
			PFunackedMessages;
			true -> NFunackedMessages
		end,
		blockedConsumerOnUnackedMsgs =
		if NFblockedConsumerOnUnackedMsgs =:=
			undefined ->
			PFblockedConsumerOnUnackedMsgs;
			true ->
				NFblockedConsumerOnUnackedMsgs
...
merge_msg_CommandGetLastMessageId(#'CommandGetLastMessageId'{},
		#'CommandGetLastMessageId'{consumer_id =
		NFconsumer_id,
			request_id =
			NFrequest_id},
		_) ->
...
merge_msg_CommandGetTopicsOfNamespace(#'CommandGetTopicsOfNamespace'{mode
=
PFmode},
		#'CommandGetTopicsOfNamespace'{request_id
		=
		NFrequest_id,
			namespace =
			NFnamespace,
...
merge_msg_CommandGetSchema(#'CommandGetSchema'{schema_version
= PFschema_version},
...
merge_msg_CommandGetSchemaResponse(#'CommandGetSchemaResponse'{error_code
=
PFerror_code,
	error_message =
	PFerror_message,
	...
	schema_version =
	PFschema_version},
		#'CommandGetSchemaResponse'{request_id =
		NFrequest_id,
			error_code =
			NFerror_code,
			error_message =
...
merge_msg_BaseCommand(#'BaseCommand'{connect =
PFconnect,
	connected = PFconnected,
	subscribe = PFsubscribe,
	producer = PFproducer, send = PFsend,
	send_receipt = PFsend_receipt,
	send_error = PFsend_error,
	message = PFmessage, ack = PFack,
	flow = PFflow, unsubscribe = PFunsubscribe,
	success = PFsuccess, error = PFerror,
	close_producer = PFclose_producer,
	close_consumer = PFclose_consumer,
	producer_success = PFproducer_success,
	ping = PFping, pong = PFpong,
	...
	authResponse = PFauthResponse},
		#'BaseCommand'{type = NFtype, connect = NFconnect,
			connected = NFconnected,
			subscribe = NFsubscribe,
			producer = NFproducer, send = NFsend,
			send_receipt = NFsend_receipt,
			send_error = NFsend_error,
			message = NFmessage, ack = NFack,
			flow = NFflow, unsubscribe = NFunsubscribe,
			success = NFsuccess, error = NFerror,
			close_producer = NFclose_producer,
			close_consumer = NFclose_consumer,
			producer_success = NFproducer_success,
			ping = NFping, pong = NFpong,
			redeliverUnacknowledgedMessages =
	...
	#'BaseCommand'{type = NFtype,
		...
		if PFconnect /= undefined, NFconnect /= undefined ->
			merge_msg_CommandConnect(PFconnect, NFconnect,
				TrUserData);
			PFconnect == undefined -> NFconnect;
			NFconnect == undefined -> PFconnect
		end,
		connected =
		...
		if PFsubscribe /= undefined, NFsubscribe /= undefined ->
			merge_msg_CommandSubscribe(PFsubscribe,
				NFsubscribe,
				TrUserData);
			PFsubscribe == undefined -> NFsubscribe;
			NFsubscribe == undefined -> PFsubscribe
		end,
		producer =
		if PFproducer /= undefined, NFproducer /= undefined ->
			merge_msg_CommandProducer(PFproducer, NFproducer,
				TrUserData);
			PFproducer == undefined -> NFproducer;
			NFproducer == undefined -> PFproducer
		end,
		send =
		if PFsend /= undefined, NFsend /= undefined ->
			merge_msg_CommandSend(PFsend, NFsend, TrUserData);
			PFsend == undefined -> NFsend;
			NFsend == undefined -> PFsend
		end,
		send_receipt =
		if PFsend_receipt /= undefined,
		NFsend_receipt /= undefined ->
			merge_msg_CommandSendReceipt(PFsend_receipt,
				NFsend_receipt,
				TrUserData);
			PFsend_receipt == undefined -> NFsend_receipt;
			NFsend_receipt == undefined -> PFsend_receipt
		end,
		send_error =
		if PFsend_error /= undefined,
		NFsend_error /= undefined ->
			merge_msg_CommandSendError(PFsend_error,
				NFsend_error,
				TrUserData);
			PFsend_error == undefined -> NFsend_error;
			NFsend_error == undefined -> PFsend_error
		end,
		message =
		...
		if PFack /= undefined, NFack /= undefined ->
			...
			PFack == undefined -> NFack;
			NFack == undefined -> PFack
		end,
		flow =
		if PFflow /= undefined, NFflow /= undefined ->
			merge_msg_CommandFlow(PFflow, NFflow, TrUserData);
			PFflow == undefined -> NFflow;
			NFflow == undefined -> PFflow
		end,
		unsubscribe =
		if PFunsubscribe /= undefined,
		NFunsubscribe /= undefined ->
			merge_msg_CommandUnsubscribe(PFunsubscribe,
				NFunsubscribe,
				TrUserData);
			PFunsubscribe == undefined -> NFunsubscribe;
			NFunsubscribe == undefined -> PFunsubscribe
		end,
		success =
		if PFsuccess /= undefined, NFsuccess /= undefined ->
			merge_msg_CommandSuccess(PFsuccess, NFsuccess,
				TrUserData);
			PFsuccess == undefined -> NFsuccess;
			NFsuccess == undefined -> PFsuccess
		end,
		error =
		if PFerror /= undefined, NFerror /= undefined ->
			merge_msg_CommandError(PFerror, NFerror,
				TrUserData);
			PFerror == undefined -> NFerror;
			NFerror == undefined -> PFerror
		end,
		close_producer =
		if PFclose_producer /= undefined,
		NFclose_producer /= undefined ->
			merge_msg_CommandCloseProducer(PFclose_producer,
				NFclose_producer,
				TrUserData);
			PFclose_producer == undefined -> NFclose_producer;
			NFclose_producer == undefined -> PFclose_producer
		end,
		close_consumer =
		if PFclose_consumer /= undefined,
		NFclose_consumer /= undefined ->
			merge_msg_CommandCloseConsumer(PFclose_consumer,
				NFclose_consumer,
				TrUserData);
			PFclose_consumer == undefined -> NFclose_consumer;
			NFclose_consumer == undefined -> PFclose_consumer
		end,
		producer_success =
		if PFproducer_success /= undefined,
		NFproducer_success /= undefined ->
			merge_msg_CommandProducerSuccess(PFproducer_success,
				NFproducer_success,
				TrUserData);
			PFproducer_success == undefined -> NFproducer_success;
			NFproducer_success == undefined -> PFproducer_success
		end,
		ping =
		if PFping /= undefined, NFping /= undefined ->
			merge_msg_CommandPing(PFping, NFping, TrUserData);
			PFping == undefined -> NFping;
			NFping == undefined -> PFping
		end,
		pong =
		if PFpong /= undefined, NFpong /= undefined ->
			merge_msg_CommandPong(PFpong, NFpong, TrUserData);
			PFpong == undefined -> NFpong;
			NFpong == undefined -> PFpong
		end,
		redeliverUnacknowledgedMessages =
		...
		partitionMetadata =
		if PFpartitionMetadata /= undefined,
		...
		lookupTopic =
		if PFlookupTopic /= undefined,
		NFlookupTopic /= undefined ->
			merge_msg_CommandLookupTopic(PFlookupTopic,
				NFlookupTopic,
				TrUserData);
			PFlookupTopic == undefined -> NFlookupTopic;
			NFlookupTopic == undefined -> PFlookupTopic
		end,
		lookupTopicResponse =
		if PFlookupTopicResponse /= undefined,
		...
		consumerStats =
		if PFconsumerStats /= undefined,
		NFconsumerStats /= undefined ->
			merge_msg_CommandConsumerStats(PFconsumerStats,
				NFconsumerStats,
				TrUserData);
			PFconsumerStats == undefined -> NFconsumerStats;
			NFconsumerStats == undefined -> PFconsumerStats
		end,
		consumerStatsResponse =
		...
		reachedEndOfTopic =
		if PFreachedEndOfTopic /= undefined,
		...
		if PFseek /= undefined, NFseek /= undefined ->
			...
			PFseek == undefined -> NFseek;
			NFseek == undefined -> PFseek
		end,
		getLastMessageId =
		if PFgetLastMessageId /= undefined,
		NFgetLastMessageId /= undefined ->
			merge_msg_CommandGetLastMessageId(PFgetLastMessageId,
				NFgetLastMessageId,
				TrUserData);
			PFgetLastMessageId == undefined -> NFgetLastMessageId;
			NFgetLastMessageId == undefined -> PFgetLastMessageId
		end,
		getLastMessageIdResponse =
		...
		if PFgetSchema /= undefined, NFgetSchema /= undefined ->
			merge_msg_CommandGetSchema(PFgetSchema,
				NFgetSchema,
				TrUserData);
			PFgetSchema == undefined -> NFgetSchema;
			NFgetSchema == undefined -> PFgetSchema
		end,
		getSchemaResponse =
		if PFgetSchemaResponse /= undefined,
		...
		authChallenge =
		if PFauthChallenge /= undefined,
		NFauthChallenge /= undefined ->
			merge_msg_CommandAuthChallenge(PFauthChallenge,
				NFauthChallenge,
				TrUserData);
			PFauthChallenge == undefined -> NFauthChallenge;
			NFauthChallenge == undefined -> PFauthChallenge
		end,
		authResponse =
		if PFauthResponse /= undefined,
		NFauthResponse /= undefined ->
			merge_msg_CommandAuthResponse(PFauthResponse,
				NFauthResponse,
				TrUserData);
			PFauthResponse == undefined -> NFauthResponse;
			NFauthResponse == undefined -> PFauthResponse
		end}.
...
v_msg_Schema(#'Schema'{name = F1, schema_data = F2,
	type = F3, properties = F4},
		Path, TrUserData) ->
...
v_msg_MessageIdData(#'MessageIdData'{ledgerId = F1,
	...
	if F3 == undefined -> ok;
		true -> v_type_int32(F3, [partition | Path], TrUserData)
	end,
	if F4 == undefined -> ok;
		true ->
...
v_msg_KeyValue(#'KeyValue'{key = F1, value = F2}, Path,
		TrUserData) ->
...
v_msg_KeyLongValue(#'KeyLongValue'{key = F1,
	value = F2},
		Path, TrUserData) ->
	v_type_string(F1, [key | Path], TrUserData),
...
v_msg_MessageMetadata(#'MessageMetadata'{producer_name =
F1,
	sequence_id = F2, publish_time = F3,
	properties = F4, replicated_from = F5,
	partition_key = F6, replicate_to = F7,
	compression = F8,
	uncompressed_size = F9,
	num_messages_in_batch = F10,
	event_time = F11,
...
v_msg_SingleMessageMetadata(#'SingleMessageMetadata'{properties
= F1,
	partition_key = F2,
	payload_size = F3,
	compacted_out = F4,
...
v_msg_CommandConnect(#'CommandConnect'{client_version =
F1,
	auth_method = F2, auth_method_name = F3,
	auth_data = F4, protocol_version = F5,
	proxy_to_broker_url = F6,
	original_principal = F7,
	original_auth_data = F8,
	original_auth_method = F9},
	...
	if F4 == undefined -> ok;
		true -> v_type_bytes(F4, [auth_data | Path], TrUserData)
	end,
	if F5 == undefined -> ok;
		true ->
...
v_msg_CommandConnected(#'CommandConnected'{server_version
= F1,
	protocol_version = F2,
	max_message_size = F3},
		Path, TrUserData) ->
...
v_msg_CommandAuthResponse(#'CommandAuthResponse'{client_version
= F1,
	response = F2,
	protocol_version = F3},
		Path, TrUserData) ->
...
v_msg_CommandAuthChallenge(#'CommandAuthChallenge'{server_version
= F1,
	challenge = F2,
	protocol_version = F3},
		Path, TrUserData) ->
...
v_msg_AuthData(#'AuthData'{auth_method_name = F1,
	auth_data = F2},
		Path, TrUserData) ->
	if F1 == undefined -> ok;
		true ->
	...
	if F2 == undefined -> ok;
		true -> v_type_bytes(F2, [auth_data | Path], TrUserData)
	end,
	ok;
...
v_msg_CommandSubscribe(#'CommandSubscribe'{topic = F1,
	...
	consumer_name = F6,
	priority_level = F7, durable = F8,
	start_message_id = F9,
	metadata = F10, read_compacted = F11,
	schema = F12, initialPosition = F13,
	...
	if F8 == undefined -> ok;
		true -> v_type_bool(F8, [durable | Path], TrUserData)
	end,
	if F9 == undefined -> ok;
		true ->
	...
	if F12 == undefined -> ok;
		true -> v_msg_Schema(F12, [schema | Path], TrUserData)
	end,
	if F13 == undefined -> ok;
		true ->
	...
	if F14 == undefined -> ok;
		true ->
			v_type_bool(F14, [replicate_subscription_state | Path],
				TrUserData)
	end,
	ok;
...
v_msg_CommandPartitionedTopicMetadata(#'CommandPartitionedTopicMetadata'{topic
=
F1,
	request_id
	=
...
v_msg_CommandLookupTopic(#'CommandLookupTopic'{topic =
F1,
	request_id = F2,
	authoritative = F3,
	original_principal = F4,
...
v_msg_CommandLookupTopicResponse(#'CommandLookupTopicResponse'{brokerServiceUrl
= F1,
	brokerServiceUrlTls
	= F2,
	response = F3,
	...
	if F7 == undefined -> ok;
		true -> v_type_string(F7, [message | Path], TrUserData)
	end,
	if F8 == undefined -> ok;
		true ->
...
v_msg_CommandProducer(#'CommandProducer'{topic = F1,
	producer_id = F2, request_id = F3,
	producer_name = F4, encrypted = F5,
	metadata = F6, schema = F7},
		Path, TrUserData) ->
	v_type_string(F1, [topic | Path], TrUserData),
	...
	if F5 == undefined -> ok;
		true -> v_type_bool(F5, [encrypted | Path], TrUserData)
	end,
	if is_list(F6) ->
		_ = [v_msg_KeyValue(Elem, [metadata | Path], TrUserData)
			|| Elem <- F6],
	...
	if F7 == undefined -> ok;
		true -> v_msg_Schema(F7, [schema | Path], TrUserData)
	end,
	ok;
...
v_msg_CommandSendReceipt(#'CommandSendReceipt'{producer_id
= F1,
	sequence_id = F2,
	message_id = F3},
		Path, TrUserData) ->
...
v_msg_CommandSendError(#'CommandSendError'{producer_id =
F1,
	sequence_id = F2, error = F3,
	message = F4},
		Path, TrUserData) ->
...
v_msg_CommandMessage(#'CommandMessage'{consumer_id = F1,
	message_id = F2, redelivery_count = F3},
		Path, TrUserData) ->
...
v_msg_CommandActiveConsumerChange(#'CommandActiveConsumerChange'{consumer_id
= F1,
	is_active =
	F2},
		Path, TrUserData) ->
	v_type_uint64(F1, [consumer_id | Path], TrUserData),
	if F2 == undefined -> ok;
		true -> v_type_bool(F2, [is_active | Path], TrUserData)
	end,
	ok;
...
v_msg_CommandFlow(#'CommandFlow'{consumer_id = F1,
	messagePermits = F2},
		Path, TrUserData) ->
	v_type_uint64(F1, [consumer_id | Path], TrUserData),
...
v_msg_CommandUnsubscribe(#'CommandUnsubscribe'{consumer_id
= F1,
	request_id = F2},
		Path, TrUserData) ->
	v_type_uint64(F1, [consumer_id | Path], TrUserData),
...
v_msg_CommandReachedEndOfTopic(#'CommandReachedEndOfTopic'{consumer_id
= F1},
		Path, TrUserData) ->
	v_type_uint64(F1, [consumer_id | Path], TrUserData), ok;
...
v_msg_CommandCloseProducer(#'CommandCloseProducer'{producer_id
= F1,
	request_id = F2},
		Path, TrUserData) ->
	v_type_uint64(F1, [producer_id | Path], TrUserData),
...
v_msg_CommandCloseConsumer(#'CommandCloseConsumer'{consumer_id
= F1,
	request_id = F2},
		Path, TrUserData) ->
	v_type_uint64(F1, [consumer_id | Path], TrUserData),
...
v_msg_CommandSuccess(#'CommandSuccess'{request_id = F1,
	schema = F2},
		Path, TrUserData) ->
	v_type_uint64(F1, [request_id | Path], TrUserData),
	if F2 == undefined -> ok;
		true -> v_msg_Schema(F2, [schema | Path], TrUserData)
	end,
	ok;
...
v_msg_CommandProducerSuccess(#'CommandProducerSuccess'{request_id
= F1,
	producer_name = F2,
	last_sequence_id = F3,
	schema_version = F4},
...
v_msg_CommandPing(#'CommandPing'{}, _Path, _) -> ok;
...
v_msg_CommandPong(#'CommandPong'{}, _Path, _) -> ok;
...
v_msg_CommandConsumerStats(#'CommandConsumerStats'{request_id
= F1,
	consumer_id = F2},
		Path, TrUserData) ->
	v_type_uint64(F1, [request_id | Path], TrUserData),
...
v_msg_CommandConsumerStatsResponse(#'CommandConsumerStatsResponse'{request_id
= F1,
	error_code =
	F2,
	error_message
	...
	if F11 == undefined -> ok;
		true -> v_type_string(F11, [address | Path], TrUserData)
	end,
	if F12 == undefined -> ok;
		true ->
	...
	if F13 == undefined -> ok;
		true -> v_type_string(F13, [type | Path], TrUserData)
	end,
	if F14 == undefined -> ok;
		true ->
...
v_msg_CommandGetLastMessageId(#'CommandGetLastMessageId'{consumer_id
= F1,
	request_id = F2},
		Path, TrUserData) ->
	v_type_uint64(F1, [consumer_id | Path], TrUserData),
...
v_msg_CommandGetTopicsOfNamespace(#'CommandGetTopicsOfNamespace'{request_id
= F1,
	namespace = F2,
	mode = F3},
		Path, TrUserData) ->
...
v_msg_CommandGetSchema(#'CommandGetSchema'{request_id =
F1,
	topic = F2, schema_version = F3},
		Path, TrUserData) ->
	v_type_uint64(F1, [request_id | Path], TrUserData),
...
v_msg_CommandGetSchemaResponse(#'CommandGetSchemaResponse'{request_id
= F1,
	error_code = F2,
	error_message = F3,
	schema = F4,
	...
	if F4 == undefined -> ok;
		true -> v_msg_Schema(F4, [schema | Path], TrUserData)
	end,
	if F5 == undefined -> ok;
		true ->
...
v_msg_BaseCommand(#'BaseCommand'{type = F1,
	connect = F2, connected = F3, subscribe = F4,
	producer = F5, send = F6, send_receipt = F7,
	send_error = F8, message = F9, ack = F10,
	flow = F11, unsubscribe = F12, success = F13,
	error = F14, close_producer = F15,
	close_consumer = F16, producer_success = F17,
	ping = F18, pong = F19,
	redeliverUnacknowledgedMessages = F20,
	partitionMetadata = F21,
	partitionMetadataResponse = F22,
	lookupTopic = F23, lookupTopicResponse = F24,
	consumerStats = F25,
	consumerStatsResponse = F26,
	reachedEndOfTopic = F27, seek = F28,
	getLastMessageId = F29,
	...
	if F6 == undefined -> ok;
		true -> v_msg_CommandSend(F6, [send | Path], TrUserData)
	end,
	if F7 == undefined -> ok;
		true ->
	...
	if F10 == undefined -> ok;
		true -> v_msg_CommandAck(F10, [ack | Path], TrUserData)
	end,
	if F11 == undefined -> ok;
		true ->
	...
	[{{enum, 'Schema.Type'},
		...
		{{msg, 'Schema'},
			[#field{name = name, fnum = 1, rnum = 2, type = string,
				...
				#field{name = schema_data, fnum = 3, rnum = 3,
					type = bytes, occurrence = required, opts = []},
				#field{name = type, fnum = 4, rnum = 4,
					type = {enum, 'Schema.Type'}, occurrence = required,
					opts = []},
				#field{name = properties, fnum = 5, rnum = 5,
					type = {msg, 'KeyValue'}, occurrence = repeated,
					opts = []}]},
		{{msg, 'MessageIdData'},
			[#field{name = ledgerId, fnum = 1, rnum = 2,
				type = uint64, occurrence = required, opts = []},
				#field{name = entryId, fnum = 2, rnum = 3,
					type = uint64, occurrence = required, opts = []},
				#field{name = partition, fnum = 3, rnum = 4,
					type = int32, occurrence = optional,
					opts = [{default, -1}]},
				#field{name = batch_index, fnum = 4, rnum = 5,
					type = int32, occurrence = optional,
					opts = [{default, -1}]}]},
		{{msg, 'KeyValue'},
		...
		{{msg, 'KeyLongValue'},
			[#field{name = key, fnum = 1, rnum = 2, type = string,
				occurrence = required, opts = []},
				#field{name = value, fnum = 2, rnum = 3, type = uint64,
					occurrence = required, opts = []}]},
		{{msg, 'EncryptionKeys'},
			[#field{name = key, fnum = 1, rnum = 2, type = string,
				occurrence = required, opts = []},
				...
				#field{name = metadata, fnum = 3, rnum = 4,
					...
					opts = []}]},
		{{msg, 'MessageMetadata'},
			[#field{name = producer_name, fnum = 1, rnum = 2,
				type = string, occurrence = required, opts = []},
				#field{name = sequence_id, fnum = 2, rnum = 3,
					type = uint64, occurrence = required, opts = []},
				#field{name = publish_time, fnum = 3, rnum = 4,
					type = uint64, occurrence = required, opts = []},
				#field{name = properties, fnum = 4, rnum = 5,
					type = {msg, 'KeyValue'}, occurrence = repeated,
					opts = []},
				#field{name = replicated_from, fnum = 5, rnum = 6,
					type = string, occurrence = optional, opts = []},
				#field{name = partition_key, fnum = 6, rnum = 7,
					type = string, occurrence = optional, opts = []},
				#field{name = replicate_to, fnum = 7, rnum = 8,
					type = string, occurrence = repeated, opts = []},
				#field{name = compression, fnum = 8, rnum = 9,
					type = {enum, 'CompressionType'}, occurrence = optional,
					opts = [{default, 'NONE'}]},
				#field{name = uncompressed_size, fnum = 9, rnum = 10,
					type = uint32, occurrence = optional,
					opts = [{default, 0}]},
				#field{name = num_messages_in_batch, fnum = 11,
					rnum = 11, type = int32, occurrence = optional,
					opts = [{default, 1}]},
				#field{name = event_time, fnum = 12, rnum = 12,
					type = uint64, occurrence = optional,
					opts = [{default, 0}]},
				#field{name = encryption_keys, fnum = 13, rnum = 13,
					type = {msg, 'EncryptionKeys'}, occurrence = repeated,
					opts = []},
				#field{name = encryption_algo, fnum = 14, rnum = 14,
					type = string, occurrence = optional, opts = []},
				#field{name = encryption_param, fnum = 15, rnum = 15,
					type = bytes, occurrence = optional, opts = []},
				#field{name = schema_version, fnum = 16, rnum = 16,
					type = bytes, occurrence = optional, opts = []},
				#field{name = partition_key_b64_encoded, fnum = 17,
					rnum = 17, type = bool, occurrence = optional,
					opts = [{default, false}]},
				#field{name = ordering_key, fnum = 18, rnum = 18,
					type = bytes, occurrence = optional, opts = []},
				#field{name = deliver_at_time, fnum = 19, rnum = 19,
					type = int64, occurrence = optional, opts = []},
				#field{name = marker_type, fnum = 20, rnum = 20,
					type = int32, occurrence = optional, opts = []}]},
		{{msg, 'SingleMessageMetadata'},
			[#field{name = properties, fnum = 1, rnum = 2,
				type = {msg, 'KeyValue'}, occurrence = repeated,
				opts = []},
				#field{name = partition_key, fnum = 2, rnum = 3,
					type = string, occurrence = optional, opts = []},
				#field{name = payload_size, fnum = 3, rnum = 4,
					type = int32, occurrence = required, opts = []},
				#field{name = compacted_out, fnum = 4, rnum = 5,
					type = bool, occurrence = optional,
					opts = [{default, false}]},
				#field{name = event_time, fnum = 5, rnum = 6,
					type = uint64, occurrence = optional,
					opts = [{default, 0}]},
				#field{name = partition_key_b64_encoded, fnum = 6,
					rnum = 7, type = bool, occurrence = optional,
					opts = [{default, false}]},
				#field{name = ordering_key, fnum = 7, rnum = 8,
					type = bytes, occurrence = optional, opts = []},
				#field{name = sequence_id, fnum = 8, rnum = 9,
					type = uint64, occurrence = optional, opts = []}]},
		{{msg, 'CommandConnect'},
			[#field{name = client_version, fnum = 1, rnum = 2,
				type = string, occurrence = required, opts = []},
				#field{name = auth_method, fnum = 2, rnum = 3,
					type = {enum, 'AuthMethod'}, occurrence = optional,
					opts = []},
				#field{name = auth_method_name, fnum = 5, rnum = 4,
					type = string, occurrence = optional, opts = []},
				#field{name = auth_data, fnum = 3, rnum = 5,
					type = bytes, occurrence = optional, opts = []},
				#field{name = protocol_version, fnum = 4, rnum = 6,
					type = int32, occurrence = optional,
					opts = [{default, 0}]},
				#field{name = proxy_to_broker_url, fnum = 6, rnum = 7,
					type = string, occurrence = optional, opts = []},
				#field{name = original_principal, fnum = 7, rnum = 8,
					type = string, occurrence = optional, opts = []},
				#field{name = original_auth_data, fnum = 8, rnum = 9,
					type = string, occurrence = optional, opts = []},
				#field{name = original_auth_method, fnum = 9, rnum = 10,
					type = string, occurrence = optional, opts = []}]},
		{{msg, 'CommandConnected'},
			[#field{name = server_version, fnum = 1, rnum = 2,
				type = string, occurrence = required, opts = []},
				#field{name = protocol_version, fnum = 2, rnum = 3,
					type = int32, occurrence = optional,
					opts = [{default, 0}]},
				#field{name = max_message_size, fnum = 3, rnum = 4,
					type = int32, occurrence = optional, opts = []}]},
		{{msg, 'CommandAuthResponse'},
			[#field{name = client_version, fnum = 1, rnum = 2,
				type = string, occurrence = optional, opts = []},
				#field{name = response, fnum = 2, rnum = 3,
					type = {msg, 'AuthData'}, occurrence = optional,
					opts = []},
				#field{name = protocol_version, fnum = 3, rnum = 4,
					type = int32, occurrence = optional,
					opts = [{default, 0}]}]},
		{{msg, 'CommandAuthChallenge'},
			[#field{name = server_version, fnum = 1, rnum = 2,
				type = string, occurrence = optional, opts = []},
				#field{name = challenge, fnum = 2, rnum = 3,
					type = {msg, 'AuthData'}, occurrence = optional,
					opts = []},
				#field{name = protocol_version, fnum = 3, rnum = 4,
					type = int32, occurrence = optional,
					opts = [{default, 0}]}]},
		{{msg, 'AuthData'},
			[#field{name = auth_method_name, fnum = 1, rnum = 2,
				type = string, occurrence = optional, opts = []},
				#field{name = auth_data, fnum = 2, rnum = 3,
					type = bytes, occurrence = optional, opts = []}]},
		{{msg, 'CommandSubscribe'},
			[#field{name = topic, fnum = 1, rnum = 2, type = string,
				occurrence = required, opts = []},
				#field{name = subscription, fnum = 2, rnum = 3,
					type = string, occurrence = required, opts = []},
				#field{name = subType, fnum = 3, rnum = 4,
					type = {enum, 'CommandSubscribe.SubType'},
					occurrence = required, opts = []},
				#field{name = consumer_id, fnum = 4, rnum = 5,
					type = uint64, occurrence = required, opts = []},
				#field{name = request_id, fnum = 5, rnum = 6,
					type = uint64, occurrence = required, opts = []},
				#field{name = consumer_name, fnum = 6, rnum = 7,
					type = string, occurrence = optional, opts = []},
				#field{name = priority_level, fnum = 7, rnum = 8,
					type = int32, occurrence = optional, opts = []},
				#field{name = durable, fnum = 8, rnum = 9, type = bool,
					occurrence = optional, opts = [{default, true}]},
				#field{name = start_message_id, fnum = 9, rnum = 10,
					type = {msg, 'MessageIdData'}, occurrence = optional,
					opts = []},
				#field{name = metadata, fnum = 10, rnum = 11,
					type = {msg, 'KeyValue'}, occurrence = repeated,
					opts = []},
				#field{name = read_compacted, fnum = 11, rnum = 12,
					type = bool, occurrence = optional, opts = []},
				#field{name = schema, fnum = 12, rnum = 13,
					type = {msg, 'Schema'}, occurrence = optional,
					opts = []},
				#field{name = initialPosition, fnum = 13, rnum = 14,
					type = {enum, 'CommandSubscribe.InitialPosition'},
					occurrence = optional, opts = [{default, 'Latest'}]},
				#field{name = replicate_subscription_state, fnum = 14,
					rnum = 15, type = bool, occurrence = optional,
					opts = []}]},
		{{msg, 'CommandPartitionedTopicMetadata'},
			[#field{name = topic, fnum = 1, rnum = 2, type = string,
				occurrence = required, opts = []},
				#field{name = request_id, fnum = 2, rnum = 3,
					type = uint64, occurrence = required, opts = []},
				#field{name = original_principal, fnum = 3, rnum = 4,
					type = string, occurrence = optional, opts = []},
				#field{name = original_auth_data, fnum = 4, rnum = 5,
					type = string, occurrence = optional, opts = []},
				#field{name = original_auth_method, fnum = 5, rnum = 6,
					type = string, occurrence = optional, opts = []}]},
		{{msg, 'CommandPartitionedTopicMetadataResponse'},
			[#field{name = partitions, fnum = 1, rnum = 2,
				type = uint32, occurrence = optional, opts = []},
				#field{name = request_id, fnum = 2, rnum = 3,
					type = uint64, occurrence = required, opts = []},
				#field{name = response, fnum = 3, rnum = 4,
					type =
					{enum,
						'CommandPartitionedTopicMetadataResponse.LookupType'},
				...
				#field{name = error, fnum = 4, rnum = 5,
					...
					opts = []},
				#field{name = message, fnum = 5, rnum = 6,
					type = string, occurrence = optional, opts = []}]},
		{{msg, 'CommandLookupTopic'},
			[#field{name = topic, fnum = 1, rnum = 2, type = string,
				...
				#field{name = request_id, fnum = 2, rnum = 3,
					type = uint64, occurrence = required, opts = []},
				#field{name = authoritative, fnum = 3, rnum = 4,
					type = bool, occurrence = optional,
					opts = [{default, false}]},
				#field{name = original_principal, fnum = 4, rnum = 5,
					type = string, occurrence = optional, opts = []},
				#field{name = original_auth_data, fnum = 5, rnum = 6,
					type = string, occurrence = optional, opts = []},
				#field{name = original_auth_method, fnum = 6, rnum = 7,
					type = string, occurrence = optional, opts = []}]},
		{{msg, 'CommandLookupTopicResponse'},
			[#field{name = brokerServiceUrl, fnum = 1, rnum = 2,
				type = string, occurrence = optional, opts = []},
				#field{name = brokerServiceUrlTls, fnum = 2, rnum = 3,
					type = string, occurrence = optional, opts = []},
				#field{name = response, fnum = 3, rnum = 4,
					type = {enum, 'CommandLookupTopicResponse.LookupType'},
					occurrence = optional, opts = []},
				#field{name = request_id, fnum = 4, rnum = 5,
					type = uint64, occurrence = required, opts = []},
				#field{name = authoritative, fnum = 5, rnum = 6,
					type = bool, occurrence = optional,
					opts = [{default, false}]},
				#field{name = error, fnum = 6, rnum = 7,
					type = {enum, 'ServerError'}, occurrence = optional,
					opts = []},
				#field{name = message, fnum = 7, rnum = 8,
					type = string, occurrence = optional, opts = []},
				#field{name = proxy_through_service_url, fnum = 8,
					rnum = 9, type = bool, occurrence = optional,
					opts = [{default, false}]}]},
		{{msg, 'CommandProducer'},
			[#field{name = topic, fnum = 1, rnum = 2, type = string,
				occurrence = required, opts = []},
				#field{name = producer_id, fnum = 2, rnum = 3,
					type = uint64, occurrence = required, opts = []},
				#field{name = request_id, fnum = 3, rnum = 4,
					type = uint64, occurrence = required, opts = []},
				#field{name = producer_name, fnum = 4, rnum = 5,
					type = string, occurrence = optional, opts = []},
				#field{name = encrypted, fnum = 5, rnum = 6,
					type = bool, occurrence = optional,
					opts = [{default, false}]},
				#field{name = metadata, fnum = 6, rnum = 7,
					type = {msg, 'KeyValue'}, occurrence = repeated,
					opts = []},
				#field{name = schema, fnum = 7, rnum = 8,
					type = {msg, 'Schema'}, occurrence = optional,
					opts = []}]},
		{{msg, 'CommandSend'},
			[#field{name = producer_id, fnum = 1, rnum = 2,
				type = uint64, occurrence = required, opts = []},
				#field{name = sequence_id, fnum = 2, rnum = 3,
					type = uint64, occurrence = required, opts = []},
				#field{name = num_messages, fnum = 3, rnum = 4,
					type = int32, occurrence = optional,
					opts = [{default, 1}]}]},
		{{msg, 'CommandSendReceipt'},
			[#field{name = producer_id, fnum = 1, rnum = 2,
				...
				#field{name = sequence_id, fnum = 2, rnum = 3,
					type = uint64, occurrence = required, opts = []},
				#field{name = message_id, fnum = 3, rnum = 4,
					type = {msg, 'MessageIdData'}, occurrence = optional,
					opts = []}]},
		{{msg, 'CommandSendError'},
			[#field{name = producer_id, fnum = 1, rnum = 2,
				...
				#field{name = sequence_id, fnum = 2, rnum = 3,
					type = uint64, occurrence = required, opts = []},
				#field{name = error, fnum = 3, rnum = 4,
					type = {enum, 'ServerError'}, occurrence = required,
					opts = []},
				#field{name = message, fnum = 4, rnum = 5,
					type = string, occurrence = required, opts = []}]},
		{{msg, 'CommandMessage'},
			[#field{name = consumer_id, fnum = 1, rnum = 2,
				type = uint64, occurrence = required, opts = []},
				#field{name = message_id, fnum = 2, rnum = 3,
					type = {msg, 'MessageIdData'}, occurrence = required,
					opts = []},
				#field{name = redelivery_count, fnum = 3, rnum = 4,
					type = uint32, occurrence = optional,
					opts = [{default, 0}]}]},
		{{msg, 'CommandAck'},
			[#field{name = consumer_id, fnum = 1, rnum = 2,
				type = uint64, occurrence = required, opts = []},
				#field{name = ack_type, fnum = 2, rnum = 3,
					type = {enum, 'CommandAck.AckType'},
					occurrence = required, opts = []},
				#field{name = message_id, fnum = 3, rnum = 4,
					type = {msg, 'MessageIdData'}, occurrence = repeated,
					opts = []},
				#field{name = validation_error, fnum = 4, rnum = 5,
					type = {enum, 'CommandAck.ValidationError'},
					occurrence = optional, opts = []},
				#field{name = properties, fnum = 5, rnum = 6,
					type = {msg, 'KeyLongValue'}, occurrence = repeated,
					opts = []}]},
		{{msg, 'CommandActiveConsumerChange'},
			[#field{name = consumer_id, fnum = 1, rnum = 2,
				type = uint64, occurrence = required, opts = []},
				#field{name = is_active, fnum = 2, rnum = 3,
					type = bool, occurrence = optional,
					opts = [{default, false}]}]},
		{{msg, 'CommandFlow'},
			[#field{name = consumer_id, fnum = 1, rnum = 2,
				type = uint64, occurrence = required, opts = []},
				#field{name = messagePermits, fnum = 2, rnum = 3,
		...
		{{msg, 'CommandSeek'},
			[#field{name = consumer_id, fnum = 1, rnum = 2,
				...
				#field{name = message_id, fnum = 3, rnum = 4,
					type = {msg, 'MessageIdData'}, occurrence = optional,
					opts = []},
				#field{name = message_publish_time, fnum = 4, rnum = 5,
					type = uint64, occurrence = optional, opts = []}]},
		...
		{{msg, 'CommandRedeliverUnacknowledgedMessages'},
			[#field{name = consumer_id, fnum = 1, rnum = 2,
				type = uint64, occurrence = required, opts = []},
				#field{name = message_ids, fnum = 2, rnum = 3,
					type = {msg, 'MessageIdData'}, occurrence = repeated,
					opts = []}]},
		{{msg, 'CommandSuccess'},
			[#field{name = request_id, fnum = 1, rnum = 2,
				type = uint64, occurrence = required, opts = []},
		...
		{{msg, 'CommandProducerSuccess'},
			[#field{name = request_id, fnum = 1, rnum = 2,
				type = uint64, occurrence = required, opts = []},
				#field{name = producer_name, fnum = 2, rnum = 3,
					type = string, occurrence = required, opts = []},
				#field{name = last_sequence_id, fnum = 3, rnum = 4,
					type = int64, occurrence = optional,
					opts = [{default, -1}]},
				#field{name = schema_version, fnum = 4, rnum = 5,
					type = bytes, occurrence = optional, opts = []}]},
		{{msg, 'CommandError'},
			[#field{name = request_id, fnum = 1, rnum = 2,
				type = uint64, occurrence = required, opts = []},
		...
		{{msg, 'CommandConsumerStats'},
			[#field{name = request_id, fnum = 1, rnum = 2,
				type = uint64, occurrence = required, opts = []},
				#field{name = consumer_id, fnum = 4, rnum = 3,
					type = uint64, occurrence = required, opts = []}]},
		{{msg, 'CommandConsumerStatsResponse'},
			[#field{name = request_id, fnum = 1, rnum = 2,
				...
				#field{name = error_code, fnum = 2, rnum = 3,
					type = {enum, 'ServerError'}, occurrence = optional,
					opts = []},
				#field{name = error_message, fnum = 3, rnum = 4,
					type = string, occurrence = optional, opts = []},
				#field{name = msgRateOut, fnum = 4, rnum = 5,
					type = double, occurrence = optional, opts = []},
				#field{name = msgThroughputOut, fnum = 5, rnum = 6,
					type = double, occurrence = optional, opts = []},
				#field{name = msgRateRedeliver, fnum = 6, rnum = 7,
					type = double, occurrence = optional, opts = []},
				#field{name = consumerName, fnum = 7, rnum = 8,
					type = string, occurrence = optional, opts = []},
				#field{name = availablePermits, fnum = 8, rnum = 9,
					type = uint64, occurrence = optional, opts = []},
				#field{name = unackedMessages, fnum = 9, rnum = 10,
					type = uint64, occurrence = optional, opts = []},
				#field{name = blockedConsumerOnUnackedMsgs, fnum = 10,
					rnum = 11, type = bool, occurrence = optional,
					opts = []},
				#field{name = address, fnum = 11, rnum = 12,
					type = string, occurrence = optional, opts = []},
				#field{name = connectedSince, fnum = 12, rnum = 13,
					type = string, occurrence = optional, opts = []},
				#field{name = type, fnum = 13, rnum = 14, type = string,
					occurrence = optional, opts = []},
				#field{name = msgRateExpired, fnum = 14, rnum = 15,
					type = double, occurrence = optional, opts = []},
				#field{name = msgBacklog, fnum = 15, rnum = 16,
					type = uint64, occurrence = optional, opts = []}]},
		...
		{{msg, 'CommandGetLastMessageIdResponse'},
			[#field{name = last_message_id, fnum = 1, rnum = 2,
				type = {msg, 'MessageIdData'}, occurrence = required,
				opts = []},
				#field{name = request_id, fnum = 2, rnum = 3,
					type = uint64, occurrence = required, opts = []}]},
		{{msg, 'CommandGetTopicsOfNamespace'},
			[#field{name = request_id, fnum = 1, rnum = 2,
				type = uint64, occurrence = required, opts = []},
				#field{name = namespace, fnum = 2, rnum = 3,
					type = string, occurrence = required, opts = []},
				#field{name = mode, fnum = 3, rnum = 4,
		...
		{{msg, 'CommandGetTopicsOfNamespaceResponse'},
			[#field{name = request_id, fnum = 1, rnum = 2,
				type = uint64, occurrence = required, opts = []},
				#field{name = topics, fnum = 2, rnum = 3, type = string,
					occurrence = repeated, opts = []}]},
		{{msg, 'CommandGetSchema'},
			[#field{name = request_id, fnum = 1, rnum = 2,
				type = uint64, occurrence = required, opts = []},
				#field{name = topic, fnum = 2, rnum = 3, type = string,
					occurrence = required, opts = []},
				#field{name = schema_version, fnum = 3, rnum = 4,
					type = bytes, occurrence = optional, opts = []}]},
		{{msg, 'CommandGetSchemaResponse'},
			[#field{name = request_id, fnum = 1, rnum = 2,
				...
				#field{name = error_message, fnum = 3, rnum = 4,
					type = string, occurrence = optional, opts = []},
				#field{name = schema, fnum = 4, rnum = 5,
					type = {msg, 'Schema'}, occurrence = optional,
					opts = []},
				#field{name = schema_version, fnum = 5, rnum = 6,
					type = bytes, occurrence = optional, opts = []}]},
		{{msg, 'BaseCommand'},
			[#field{name = type, fnum = 1, rnum = 2,
				type = {enum, 'BaseCommand.Type'},
				occurrence = required, opts = []},
				#field{name = connect, fnum = 2, rnum = 3,
					type = {msg, 'CommandConnect'}, occurrence = optional,
					opts = []},
				#field{name = connected, fnum = 3, rnum = 4,
					type = {msg, 'CommandConnected'}, occurrence = optional,
					opts = []},
				#field{name = subscribe, fnum = 4, rnum = 5,
					type = {msg, 'CommandSubscribe'}, occurrence = optional,
					opts = []},
				#field{name = producer, fnum = 5, rnum = 6,
					type = {msg, 'CommandProducer'}, occurrence = optional,
					opts = []},
				#field{name = send, fnum = 6, rnum = 7,
					type = {msg, 'CommandSend'}, occurrence = optional,
					opts = []},
				#field{name = send_receipt, fnum = 7, rnum = 8,
					type = {msg, 'CommandSendReceipt'},
					occurrence = optional, opts = []},
				#field{name = send_error, fnum = 8, rnum = 9,
					type = {msg, 'CommandSendError'}, occurrence = optional,
					opts = []},
				#field{name = message, fnum = 9, rnum = 10,
					type = {msg, 'CommandMessage'}, occurrence = optional,
					opts = []},
				#field{name = ack, fnum = 10, rnum = 11,
					type = {msg, 'CommandAck'}, occurrence = optional,
					opts = []},
				#field{name = flow, fnum = 11, rnum = 12,
					type = {msg, 'CommandFlow'}, occurrence = optional,
					opts = []},
				#field{name = unsubscribe, fnum = 12, rnum = 13,
					type = {msg, 'CommandUnsubscribe'},
					occurrence = optional, opts = []},
				#field{name = success, fnum = 13, rnum = 14,
					type = {msg, 'CommandSuccess'}, occurrence = optional,
					opts = []},
				#field{name = error, fnum = 14, rnum = 15,
					type = {msg, 'CommandError'}, occurrence = optional,
					opts = []},
				#field{name = close_producer, fnum = 15, rnum = 16,
					type = {msg, 'CommandCloseProducer'},
					occurrence = optional, opts = []},
				#field{name = close_consumer, fnum = 16, rnum = 17,
					type = {msg, 'CommandCloseConsumer'},
					occurrence = optional, opts = []},
				#field{name = producer_success, fnum = 17, rnum = 18,
					type = {msg, 'CommandProducerSuccess'},
					occurrence = optional, opts = []},
				#field{name = ping, fnum = 18, rnum = 19,
					type = {msg, 'CommandPing'}, occurrence = optional,
					opts = []},
				#field{name = pong, fnum = 19, rnum = 20,
				...
				#field{name = redeliverUnacknowledgedMessages,
					...
					occurrence = optional, opts = []},
				#field{name = partitionMetadata, fnum = 21, rnum = 22,
					type = {msg, 'CommandPartitionedTopicMetadata'},
					occurrence = optional, opts = []},
				#field{name = partitionMetadataResponse, fnum = 22,
					rnum = 23,
					type = {msg, 'CommandPartitionedTopicMetadataResponse'},
					occurrence = optional, opts = []},
				#field{name = lookupTopic, fnum = 23, rnum = 24,
					type = {msg, 'CommandLookupTopic'},
					occurrence = optional, opts = []},
				#field{name = lookupTopicResponse, fnum = 24, rnum = 25,
					type = {msg, 'CommandLookupTopicResponse'},
					occurrence = optional, opts = []},
				#field{name = consumerStats, fnum = 25, rnum = 26,
					type = {msg, 'CommandConsumerStats'},
					occurrence = optional, opts = []},
				#field{name = consumerStatsResponse, fnum = 26,
					rnum = 27, type = {msg, 'CommandConsumerStatsResponse'},
					occurrence = optional, opts = []},
				#field{name = reachedEndOfTopic, fnum = 27, rnum = 28,
					type = {msg, 'CommandReachedEndOfTopic'},
					occurrence = optional, opts = []},
				#field{name = seek, fnum = 28, rnum = 29,
					type = {msg, 'CommandSeek'}, occurrence = optional,
					opts = []},
				#field{name = getLastMessageId, fnum = 29, rnum = 30,
					type = {msg, 'CommandGetLastMessageId'},
					occurrence = optional, opts = []},
				#field{name = getLastMessageIdResponse, fnum = 30,
					rnum = 31,
					type = {msg, 'CommandGetLastMessageIdResponse'},
					occurrence = optional, opts = []},
				#field{name = active_consumer_change, fnum = 31,
					rnum = 32, type = {msg, 'CommandActiveConsumerChange'},
					occurrence = optional, opts = []},
				#field{name = getTopicsOfNamespace, fnum = 32,
					rnum = 33, type = {msg, 'CommandGetTopicsOfNamespace'},
					occurrence = optional, opts = []},
				#field{name = getTopicsOfNamespaceResponse, fnum = 33,
					rnum = 34,
					type = {msg, 'CommandGetTopicsOfNamespaceResponse'},
					occurrence = optional, opts = []},
				#field{name = getSchema, fnum = 34, rnum = 35,
					type = {msg, 'CommandGetSchema'}, occurrence = optional,
					opts = []},
				#field{name = getSchemaResponse, fnum = 35, rnum = 36,
					type = {msg, 'CommandGetSchemaResponse'},
					occurrence = optional, opts = []},
				#field{name = authChallenge, fnum = 36, rnum = 37,
					type = {msg, 'CommandAuthChallenge'},
					occurrence = optional, opts = []},
				#field{name = authResponse, fnum = 37, rnum = 38,
...
get_proto_by_msg_name_as_fqbin(<<"pulsar.proto.SingleMessageMetadata">>) -> "pulsar_api";
get_proto_by_msg_name_as_fqbin(<<"pulsar.proto.Schema">>) -> "pulsar_api";
get_proto_by_msg_name_as_fqbin(<<"pulsar.proto.MessageMetadata">>) -> "pulsar_api";
get_proto_by_msg_name_as_fqbin(<<"pulsar.proto.MessageIdData">>) -> "pulsar_api";
get_proto_by_msg_name_as_fqbin(<<"pulsar.proto.CommandPartitionedTopicMetadata">>) -> "pulsar_api";
get_proto_by_msg_name_as_fqbin(<<"pulsar.proto.CommandGetSchema">>) -> "pulsar_api";
get_proto_by_msg_name_as_fqbin(<<"pulsar.proto.AuthData">>) -> "pulsar_api";
get_proto_by_msg_name_as_fqbin(<<"pulsar.proto.CommandSendError">>) -> "pulsar_api";
get_proto_by_msg_name_as_fqbin(<<"pulsar.proto.CommandProducer">>) -> "pulsar_api";
get_proto_by_msg_name_as_fqbin(<<"pulsar.proto.CommandError">>) -> "pulsar_api";
get_proto_by_msg_name_as_fqbin(<<"pulsar.proto.CommandCloseProducer">>) -> "pulsar_api";
get_proto_by_msg_name_as_fqbin(<<"pulsar.proto.CommandCloseConsumer">>) -> "pulsar_api";
get_proto_by_msg_name_as_fqbin(<<"pulsar.proto.EncryptionKeys">>) -> "pulsar_api";
get_proto_by_msg_name_as_fqbin(<<"pulsar.proto.CommandSuccess">>) -> "pulsar_api";
get_proto_by_msg_name_as_fqbin(<<"pulsar.proto.CommandRedeliverUnacknowledgedMessages">>) -> "pulsar_api";
get_proto_by_msg_name_as_fqbin(<<"pulsar.proto.CommandReachedEndOfTopic">>) -> "pulsar_api";
get_proto_by_msg_name_as_fqbin(<<"pulsar.proto.CommandProducerSuccess">>) -> "pulsar_api";
get_proto_by_msg_name_as_fqbin(<<"pulsar.proto.CommandLookupTopic">>) -> "pulsar_api";
get_proto_by_msg_name_as_fqbin(<<"pulsar.proto.CommandConsumerStats">>) -> "pulsar_api";
get_proto_by_msg_name_as_fqbin(<<"pulsar.proto.CommandSendReceipt">>) -> "pulsar_api";
get_proto_by_msg_name_as_fqbin(<<"pulsar.proto.CommandSend">>) -> "pulsar_api";
get_proto_by_msg_name_as_fqbin(<<"pulsar.proto.CommandGetLastMessageId">>) -> "pulsar_api";
get_proto_by_msg_name_as_fqbin(<<"pulsar.proto.CommandConnected">>) -> "pulsar_api";
get_proto_by_msg_name_as_fqbin(<<"pulsar.proto.CommandConnect">>) -> "pulsar_api";
get_proto_by_msg_name_as_fqbin(<<"pulsar.proto.BaseCommand">>) -> "pulsar_api";
get_proto_by_msg_name_as_fqbin(<<"pulsar.proto.KeyValue">>) -> "pulsar_api";
get_proto_by_msg_name_as_fqbin(<<"pulsar.proto.KeyLongValue">>) -> "pulsar_api";
get_proto_by_msg_name_as_fqbin(<<"pulsar.proto.CommandUnsubscribe">>) -> "pulsar_api";
get_proto_by_msg_name_as_fqbin(<<"pulsar.proto.CommandSubscribe">>) -> "pulsar_api";
get_proto_by_msg_name_as_fqbin(<<"pulsar.proto.CommandPartitionedTopicMetadataResponse">>) -> "pulsar_api";
get_proto_by_msg_name_as_fqbin(<<"pulsar.proto.CommandMessage">>) -> "pulsar_api";
get_proto_by_msg_name_as_fqbin(<<"pulsar.proto.CommandLookupTopicResponse">>) -> "pulsar_api";
get_proto_by_msg_name_as_fqbin(<<"pulsar.proto.CommandGetTopicsOfNamespaceResponse">>) -> "pulsar_api";
get_proto_by_msg_name_as_fqbin(<<"pulsar.proto.CommandGetTopicsOfNamespace">>) -> "pulsar_api";
get_proto_by_msg_name_as_fqbin(<<"pulsar.proto.CommandGetSchemaResponse">>) -> "pulsar_api";
get_proto_by_msg_name_as_fqbin(<<"pulsar.proto.CommandGetLastMessageIdResponse">>) -> "pulsar_api";
get_proto_by_msg_name_as_fqbin(<<"pulsar.proto.CommandConsumerStatsResponse">>) -> "pulsar_api";
get_proto_by_msg_name_as_fqbin(<<"pulsar.proto.CommandAuthResponse">>) -> "pulsar_api";
get_proto_by_msg_name_as_fqbin(<<"pulsar.proto.CommandAuthChallenge">>) -> "pulsar_api";
get_proto_by_msg_name_as_fqbin(<<"pulsar.proto.CommandActiveConsumerChange">>) -> "pulsar_api";
get_proto_by_msg_name_as_fqbin(<<"pulsar.proto.CommandPong">>) -> "pulsar_api";
get_proto_by_msg_name_as_fqbin(<<"pulsar.proto.CommandPing">>) -> "pulsar_api";
get_proto_by_msg_name_as_fqbin(<<"pulsar.proto.CommandFlow">>) -> "pulsar_api";
get_proto_by_msg_name_as_fqbin(<<"pulsar.proto.CommandSeek">>) -> "pulsar_api";
get_proto_by_msg_name_as_fqbin(<<"pulsar.proto.CommandAck">>) -> "pulsar_api";
...
get_proto_by_enum_name_as_fqbin(<<"pulsar.proto.CommandSubscribe.SubType">>) ->
	"pulsar_api";
get_proto_by_enum_name_as_fqbin(<<"pulsar.proto.CommandPartitionedTopicMetadataResponse.LookupType">>) ->
	"pulsar_api";
get_proto_by_enum_name_as_fqbin(<<"pulsar.proto.CommandLookupTopicResponse.LookupType">>) ->
	"pulsar_api";
